<div class="tabs">
	...
	<div class="tab-content tab-js active">
		<p>Grab the script (jQuery) from GitHub:</p>
		<a target="_blank" href="https://github.com/luukdv/animated-menu-icons/blob/master/js/icon.js">jQuery</a>
	</div>
	<div class="tab-content tab-css">
		<p>Pick up the styling (SCSS) from GitHub:</p>
	...
	<div class="tab-content tab-html">
		<p>Get the markup (HTML) from GitHub:</p>
		<a target="_blank" href="https://github.com/luukdv/animated-menu-icons/blob/master/partials/icons/<?php echo $type; ?>/icon<?php echo $i; ?>.html">HTML</a>
	</div>
</div>
